...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 dark:bg-gray-900 transition-colors duration-300">
      {/* Header */}
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm dark:bg-gray-800 dark:border-gray-700 transition-colors duration-300">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-brand-500 to-brand-700 flex items-center justify-center text-white font-bold text-lg shadow-md">
              M
            </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {configError && (
          <div className="mb-8 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3 animate-pulse dark:bg-red-900/20 dark:border-red-800">
             ...
             <div>
               <h3 className="font-bold text-red-800 dark:text-red-300">Atenção: Chave de API Ausente</h3>
               <p className="text-red-700 mt-1 dark:text-red-400">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-4 transition-colors">
            Transforme seu design em <span className="text-brand-600 dark:text-brand-400">Realidade</span>
          </h2>
        ...
        {hasStarted && (
          <div className="mt-16">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-gray-900 dark:text-white transition-colors">Resultados</h3>
            </div>
